...
<div class="row dashboard-content-wrapper">
    <div class="col-md-12 stock-details">
        <div class="col-xl-12">
                        ...
                        <div class="chart-content">
                            ...
                            <div class="d-flex justify-content-end p-10" id="range_btn_group">
                                <div class="btn-group btn-group-square" id="range_group" role="group">
                                    ...
                                    <button class="btn btn-outline-dark btn-sm" type="button" onclick="updateChart('3m', this)" style="padding: 0.3rem 0.8rem;">3m</button>
                                    <button class="btn btn-outline-dark btn-sm" type="button" onclick="updateChart('6m', this)" style="padding: 0.3rem 0.8rem;">6m</button>
                                    <button class="btn btn-outline-dark btn-sm" type="button" onclick="updateChart('ytd', this)" style="padding: 0.3rem 0.8rem;">ytd</button>
                                    <button class="btn btn-outline-dark btn-sm" type="button" onclick="updateChart('1y', this)" style="padding: 0.3rem 0.8rem;">1y</button>
                                    <button class="btn btn-outline-dark btn-sm" type="button" onclick="updateChart('2y', this)" style="padding: 0.3rem 0.8rem;">2y</button>
                                    <button class="btn btn-outline-dark btn-sm" type="button" onclick="updateChart('5y', this)" style="padding: 0.3rem 0.8rem;">5y</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @if(array_get($data, 'exchange') != 'XNYS')
                        <small class="d-block">We don't have real time prices for this stock at the moment. All prices here are based on the last close price. When submitting an trade, we will confirm the actual price with you.</small>
                        @endif
                        <div class="row mt-3">
