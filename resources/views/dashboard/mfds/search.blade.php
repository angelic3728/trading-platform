        ...
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    @else
                    <h4 class="mb-0">All Mutual Funds ({{ $stocks->total() }})</h4>
                    @endif
                </div>
                <div class="col-auto">
                    <form action="{{ route('mfds.search') }}">
                        <div class="search d-flex">
                            <input type="text" class="form-control" placeholder="Search" name="q" value="{{ request()->q }}">
                            <button type="submit" class="btn btn-iconsolid" ><i class="fa fa-search"></i></button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right" nowrap>
                                    <a type="button" class="btn btn-outline-success btn-xs" href="{{ route('mfds.show', ['symbol' => $stock->symbol]) }}">See More</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
