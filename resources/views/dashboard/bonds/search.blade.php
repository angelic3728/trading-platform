        ...
        <div class="card-body col-sm-12 bond-contents">
            ...
            <div class="owl-carousel owl-theme d-sm-none" id="owl-carousel-14">
                <div class="item">
                    <div class="row">
                        <div class="col-12">
                            <div class="owl-carousel-16 owl-carousel owl-theme" id="bond_carousel0">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        <div class="col-12">
                            <div class="owl-carousel-16 owl-carousel owl-theme" id="bond_carousel1">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        <div class="col-12">
                            <div class="owl-carousel-16 owl-carousel owl-theme" id="bond_carousel2">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        <div class="col-12">
                            <div class="owl-carousel-16 owl-carousel owl-theme" id="bond_carousel3">
                            </div>
                        </div>
                    </div>
                </div>
